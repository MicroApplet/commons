 ...
 */
@Setter
@Component(CurrentRoleBean.CURRENT_ROLE_BEAN)
public class CurrentRoleBean implements ApplicationContextAware {
    public static final String CURRENT_ROLE_BEAN = "innerCurrentRoleBean";
