...
public enum Res implements ResCode {
    ...
    UnKnownPlatformType(400,true,"PLATFORM-TYPE:UNKNOWN","不支持的平台类型"),
    UnSupportPlatformType(400,true,"PLATFORM-TYPE:UN-SUPPORT","不支持的平台类型"),

    UnKnownPlatformAppType(400,true,"PLATFORM-APP-TYPE:UNKNOWN","不支持的平台应用类型"),
    UnSupportPlatformAppType(400,true,"PLATFORM-APP-TYPE:UN-SUPPORT","不支持的平台应用类型"),
