...
public abstract class SensitiveHandler {
    ...
    public static String mask(SensitiveType type, String source, int prefix, int suffix, Function<String, String> function) {
        return mask(type, source, prefix, suffix, StringUtils.EMPTY, false, function);
    }

    public static String mask(SensitiveType type, String source, String regex, boolean match, Function<String, String> function) {
        return mask(type, source, type.getPrefix(), type.getSuffix(), regex, match, function);
    }

    public static String mask(SensitiveType type, String source, int prefix, int suffix, String regex, boolean match, Function<String, String> function) {
    ...
    public static String maskWithIndex(String s, int prefix, int suffix) {
