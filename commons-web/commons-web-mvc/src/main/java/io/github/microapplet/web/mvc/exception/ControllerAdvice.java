...
package io.github.microapplet.web.mvc.exception;

import io.github.microapplet.common.cons.HttpHeaderCons;
...
import io.github.microapplet.common.exception.SystemException;
...
public class ControllerAdvice  {
    ...
    public Result<Void> handleSysException(SystemException e) {
        log.info("系统错误：{}", e.toString());
        return e.<Void>create().setErrs(Collections.singletonList(e.getTrace()));
    }
